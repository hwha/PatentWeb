    ...
    state.forceGraph
      ...
      .onFinishUpdate(() => {
        ...
        if (state._dragControls) {
          const curNodeDrag = state.graphData.nodes.find(node => node.__initialFixedPos && !node.__disposeControlsAfterDrag); // detect
                                                                                                                                // if
                                                                                                                                // there's
                                                                                                                                // a
                                                                                                                                // node
                                                                                                                                ...
                                                                                                                                // controls
          if (curNodeDrag) {
            curNodeDrag.__disposeControlsAfterDrag = true; // postpone previous
                                                            // controls disposal
                                                            // until drag ends
          } else {
        ...
        if (state.enableNodeDrag && state.enablePointerInteraction && state.forceEngine === 'd3') { // Can't
                                                                                                    // access
                                                                                                    // node
                                                                                                    // positions
                                                                                                    // programatically
          ...
          dragControls.addEventListener('drag', function (event) {
            state.ignoreOneClick = true; // Don't click the node if it's
                                            // being dragged
            ...
            state.forceGraph
              .d3AlphaTarget(0.3) // keep engine running at low intensity
                                    // throughout drag
          ...
          dragControls.addEventListener('dragend', function (event) {
            ...
            state.forceGraph
              ...
              .resetCountdown();  // let the engine readjust after releasing
                                    // fixed nodes
